...
(defun q-shell (&optional args)
  ...
  ;(message "Starting q: \"%s\"" cmd)
  ; "/home/e/q/l32/q"
  ; (concat (getenv "HOME") ".emacs.d/q-mode/launch-q.sh")
  ; (comint-exec buf "q" (concat (getenv "HOME") "/.emacs.d/q-mode/launch-q.sh") nil (list args))
  ;(comint-exec buf "q" "/ssh:cq@localhost:/home/cq/.bin/q" nil (list args))
  (comint-exec buf "q" "su" nil '("cq" "-c" "QHOME=/home/cq/q/ /home/cq/q/l32/q"))
  ; (start-process "q" buf "su" "cq" "-c" "QHOME=/home/cq/q/ /home/cq/q/l32/q")
...
(defun q-show (var)
  ...
  (q-send-string (format "show %s" var)))
...
(defun q-console (height width)
  ...
  (q-send-string (format "\\c %d %d" height width)))
...
(defvar q-font-lock-keywords-1
  ...
  (append q-font-lock-keywords
	  ...
	  (list
	   ...
	   '("\\b[a-zA-Z]\\(?:\\w\\|[.]\\)*?[ \t]*,?::?" . font-lock-variable-name-face) ; variables
